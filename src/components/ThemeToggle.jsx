...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      aria-pressed={isDark}
      className="relative inline-flex cursor-pointer h-6 w-11 shrink-0 items-center rounded-full border border-[var(--border)] bg-[var(--code-bg)] transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-[var(--accent)]"
    >

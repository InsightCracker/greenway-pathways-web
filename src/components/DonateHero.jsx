export default function DonateHero() {
  return (
    <section className="relative flex h-[280px] items-center justify-center overflow-hidden text-center sm:h-[320px]">
      <img
        src="https://images.pexels.com/photos/21932230/pexels-photo-21932230.jpeg?auto=compress&cs=tinysrgb&w=1600"
        alt=""
        className="absolute inset-0 h-full w-full object-cover"
      />
      <div className="absolute inset-0 bg-[var(--brand-green)]/80" />
      <div className="relative">
        <p className="font-display text-[36px] text-white sm:text-[44px] pb-5">Donate</p>

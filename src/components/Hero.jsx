export default function Hero() {
  return (
    <section className="relative isolate flex h-[100dvh] min-h-[640px] w-full flex-col items-center justify-center overflow-hidden px-6 text-center">
    {/* Video background */}
    ...
    <div className="relative z-10 flex max-w-2xl flex-col items-center gap-4">
        <p className="reveal reveal-1 text-[13px] font-semibold tracking-wide text-[var(--accent)]">
          CREATING OPPORTUNITIES, TRANSFORMING LIVES
        </p>
        <h1 className="reveal reveal-2 mt-3 text-[40px] font-medium leading-tight text-white">
          Pathways to education, dignity &amp; opportunity
        </h1>
        <p className="reveal reveal-3 mt-4 max-w-md text-[15px] text-white/85">
        ...
        <div className="reveal reveal-4 mt-6 flex flex-wrap justify-center gap-3">
          <a
            href="/contact"
          ...
          <a
            href="/programs"
            className="rounded-full border border-white px-6 py-2.5 text-[14px] font-semibold text-white transition-colors duration-300 hover:bg-white hover:text-[var(--text-h)]"
          >
            See our programmes
          </a>
        </div>
